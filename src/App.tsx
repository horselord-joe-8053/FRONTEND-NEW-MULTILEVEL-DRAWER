...
// jjw: earger loading configs on class being loaded, not withing ResponsiveDrawer()
// jjw:   for efficiency. but this is temporary
// jjw: TODO: need to merge with the other frontend code, getting the role of user
import { Role, getFilledConfigByRole } from './drawer-menu/RoleToLayoutMap';
const filledConfig = getFilledConfigByRole(Role.Admin);
